...
## DOCUMENTAÇÃO DO ARQUIVOS DE CONFIGURAÇÃO DOS SERVIÇOS IMPLEMENTADOS NO UBUNTU SERVER

#01_ Arquivos de configuração do Serviço do OpenSSH Server<br>
	a) sshd_config: arquivo de configuração do serviço do OpenSSH Server;
	b) issue.net..: arquivo de configuração do Banner do OpenSSH Server;
