...
ALGUM TEMPO PEDE PARA ATUALIZAR O SISTEMA, APÓS A ATUALIZAÇÃO O SISTEMA DO WORDPRESS ELE FICA 
FORA DO AR (INDISPONÍVEL) E APRESENTA A MENSAGEM: Momentaneamente indisponível para manutenção 
...
ACONTECER QUE ELE NÃO VOLTE, PARA CORRIGIR ESSA FALHA DIGITE OS COMANDOS ABAIXO (SOMENTE SE 
NECESSÁRIO):
