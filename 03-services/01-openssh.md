...
#11_ DESAFIO-01: PERMITIR QUE O USUÁRIO: <span style="color:red">**admin**</span> SE CONECTE REMOTAMENTE NO SERVIDOR UBUNTU SERVER VIA SSH UTILIZANDO O POWERSHELL, PUTTY OU TERMINAL NO LINUX.

#12_ DESAFIO-02: CRIAR UM USUÁRIO COM O SEU NOME, EXEMPLO: **robson** (TUDO EM MINÚSCULO), FAZER O MESMO PROCEDIMENTO PARA ADICIONAR O SEU USUÁRIO AO GRUPO: **sudo** E PERMITIR QUE O SEU USUÁRIO ACESSE O SERVIDOR UBUNTU SERVER VIA SSH.
