...
#09_ Desafios do Novo Projeto de Site e Usuários do Apache2 (Etapas: 09 até 12).<br>
...
> **Prompt-02:** Por que esse software é o mais utilizado, por que o Microsoft Windows Server com o IIS não está mais no topo da lista dos principais serviços de hospedagem de sites dinâmicos?

> **Prompt-03:** Você recomendaria o Microsoft Windows Server, XAMP ou WAMP para essa implementação em Larga Escala (produção de uma empresa de Médio ou Grande porte), poderia me explicar o por que?
...
> **OBSERVAÇÃO IMPORTANTE:** nesse exemplo vamos editar os arquivos: __`teste.html, teste.php e phpinfo.php`__ utilizando o Editor de Texto em Linha de Comando: __`vim`__.
...
<!DOCTYPE html>
    ...
    <html lang="pt-br">
        ...
        <body>
            ...
            Autor......: Robson Vaamonde<br>
            Editado por: SEU NOME E SOBRENOME AQUI<br>
    ...
    <html lang="pt-br">
        ...
        <body>
            ...
            <?php 
                ...
                echo 'Editado por: SEU NOME E SOBRENOME AQUI<br>';
