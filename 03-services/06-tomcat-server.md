...
#download da última versão do Apache Tomcat Server (link atualizado em 19/02/2025)
...
wget -v -O /tmp/tomcat11.tar.gz https://dlcdn.apache.org/tomcat/tomcat-11/v11.0.18/bin/apache-tomcat-11.0.18.tar.gz
```
